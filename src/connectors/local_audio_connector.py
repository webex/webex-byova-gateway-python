...
class LocalAudioConnector(IVendorConnector):
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self.logger.info(f"LocalAudioConnector initialized with audio path: {self.audio_base_path}")
    ...
    def send_message(self, session_id: str, message_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def convert_wxcc_to_vendor(self, grpc_data: Any) -> Any:
        ...
        if hasattr(grpc_data, 'voice_va_input_type'):
            ...
            if hasattr(grpc_data, 'audio_input'):
                ...
                return {
                    'type': 'dtmf',
                    'dtmf_digits': grpc_data.dtmf_input.dtmf_digits
                }
            elif hasattr(grpc_data, 'event_input'):
                return {
                    'type': 'event',
                    'event_type': grpc_data.event_input.event_type
                }
